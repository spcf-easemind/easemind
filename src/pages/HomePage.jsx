...
import { Title, Box, FileInput, Button, LoadingOverlay, Image } from "@mantine/core";
import { useUsersStore } from "../store/users";
import { useShallow } from "zustand/shallow";
import { useForm } from "@mantine/form";

export default function HomePage() {
  const { data, message, loading, getUserInfoFn, getAllUsersFn, updateUserInfoFn, deleteUserInfoFn, } = useUsersStore(
    useShallow((state) => ({
      data: state.data,
